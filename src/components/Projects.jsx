    ...
    <section className="projects" id="projects">
      <div className="projects-container">
        ...
        <p className="projects-subtitle">
          A few projects I’ve built while learning modern web development.
        </p>
...
<div className="project-card featured">
  ...
  <p>
    Built as part of VectorShift’s technical frontend assessment, this project
    implements a node-based workflow builder with drag-and-drop functionality,
    dynamic nodes, and real-time backend validation.
  </p>

  <p>
    A FastAPI backend parses pipeline data, validates DAG structure, computes
    nodes and edges, and communicates results back to the UI via REST APIs.
    Completed and submitted under a strict deadline.
  </p>
  ...
  >
    ...
    <a className="btn secondary" href="https://github.com/Manas-Sharma-210/NETFLIX-CLONE" target="_blank"  rel="noreferrer">
      GitHub
    </a>
  </div>
</div>
          ...
          <div className="project-card in-progress">
            ...
            <p>
              ...
              focused on clean UI, visual storytelling, and smooth user
              experience.
            </p>
